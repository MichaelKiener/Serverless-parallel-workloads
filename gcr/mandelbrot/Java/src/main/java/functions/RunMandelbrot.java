...
public class RunMandelbrot {
  ...
  class MandelbrotController {
    ...
    String execute(@RequestBody Map<String, String> inputParams) throws NumberFormatException, InterruptedException  {
      ...
      String res = mandelbrot.runMandelbrot(inputParams.get("Input"), Integer.parseInt(inputParams.get("Threads")));
      res += "\n" + addInfo;
      return res;
    }
  }
  ...
  public static void main(String[] args) {
    SpringApplication.run(RunMandelbrot.class, args);
  }
}
