...
public class RunGoFast {
  ...
  class GoFastController {
    ...
    String execute(@RequestBody Map<String, String> inputParams) throws NumberFormatException, InterruptedException  {
      ...
      String res = gf.runGoFast(inputParams.get("Input"), Integer.parseInt(inputParams.get("Threads")));
      res += "\n" + addInfo;
  ...
  public static void main(String[] args) {
    SpringApplication.run(RunGoFast.class, args);
  }
}
